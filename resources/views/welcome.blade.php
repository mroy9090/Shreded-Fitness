...
<head>
    <meta charset="utf-8">
    <title>Shreded Fitness</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free Website Template" name="keywords">
    <meta content="Free Website Template" name="description">

    <!-- Favicon -->
    <link href="{{ asset("gym/img/favicon.ico") }}" rel="icon">

    <!-- Font Awesome -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet">

    <!-- Flaticon Font -->
<link href="{{ asset("gym/lib/flaticon/font/flaticon.css") }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
<link href="{{ asset("gym/css/style.min.css") }}" rel="stylesheet">
</head>
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="" class="navbar-brand">
                <h1 class="m-0 display-4 font-weight-bold text-uppercase text-white">SHREDED FITNESS</h1>
            </a>
        ...
        <div id="blog-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset("gym/img/coursol1.jpg")}}" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset("gym/img/cursol2.jpg")}}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h3 class="text-primary text-capitalize m-0">Gym & Fitness Center</h3>
    ...
    <div class="footer container-fluid mt-5 py-5 px-sm-3 px-md-5 text-white">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>1/B hatkhola ( Near Christian graveyard , tipusultan road ,wari, dhaka - 1203</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+8801832111242</p>
